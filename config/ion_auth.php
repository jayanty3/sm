...
$config['admin_email']                = "thepranav007@sg2plcpnl0154.prod.sin2.secureserver.net"; // Admin Email, admin@example.com
...
$config['email_config'] = array(
	'protocol' => 'smtp',
	'smtp_host' => 'sg2plcpnl0154.prod.sin2.secureserver.net',
	'smtp_timeout'=>30,
	'smtp_port' => 587,
	'smtp_user' => 'contact-gfm@designermore.com',
	'smtp_pass' => 'a}+wP8RPD~Am',
	'charset'=>'utf-8',
	'mailtype' => 'html',
	'newline'=>'\r\n'
);
...
$config['message_start_delimiter'] = '<div class="alert-info>'; 	// Message start delimiter
$config['message_end_delimiter']   = '</div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<p class="text-danger">';		// Error message start delimiter
