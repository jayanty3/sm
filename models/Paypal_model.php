...
class Paypal_model extends CI_Model {
	...
	function create($Total,$SubTotal,$Tax,$PaymentMethod,$PayerStatus,$PayerMail,$saleId,$CreateTime,$UpdateTime,$State,$cust_id,$payment_id) {
		...
		$this->db->set('PaymentId',$payment_id);
