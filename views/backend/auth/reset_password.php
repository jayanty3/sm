        ...
        <div class="col-md-4">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
             <center> <h3 class="box-title"><?php echo lang('reset_password_heading');?></h3></center>
...
<?php echo form_open('backend/auth/reset_password/' . $code);?>
	...
	<?php echo form_hidden($csrf); ?>
                 ...
                 <div class="box-footer">
                 	<?php echo form_submit('submit', lang('reset_password_submit_btn'),['class'=>'btn btn-flat btn-primary']);?></div>
