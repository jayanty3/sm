                                                ...
                                                <ul class="row">
                                                    ...
                                                    <li class="col-md-12 form-group">
                                                        <input type="email" class="form-control"
                                                               name="identity" id="identity1" placeholder="Enter Email"  value="<?= $this->form_validation->set_value('identity'); ?>" 
                                                    ...
                                                    <li class="col-md-12 form-group">
                                                      ...
                                                      <center><a href="<?= site_url('backend/auth/forgot_password
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <fieldset>
                   ...
                   <center> <h3 class="box-title"><?php echo lang('forgot_password_heading');?></h3></center>
                   <p>&nbsp;</p>
                   ...
                   <div class="box-footer">
                     ...
                     <?= anchor('home', 'Back',['class'=>'btn btn-flat btn-primary pull-left']);?> <?php echo form_submit('submit', lang('forgot_password_submit_btn'),['class'=>'btn btn-flat btn-primary pull-right']);?>
                   </div>
