            ...
            <div class="contact-form">
                ...
                <form method="post" class="form-horizontal" role="form" action="<?= base_url() ?>paypal_center/create_payment_with_paypal">
                    <fieldset>
                        ...
                        <input title="item_price" name="item_price" type="hidden" value="400">
                        <input title="details_tax" name="details_tax" type="hidden" value="50">
                        <input title="details_subtotal" name="details_subtotal" type="hidden" value="400">
