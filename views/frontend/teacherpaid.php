 ...
 <input type="hidden" name="onload" id="onload" value="<?php  if($this->session->flashdata('succ2') == TRUE)
     ...
     <center><?php echo validation_errors(); ?></center> 
      ...
      <section class="products">
        ...
        <?=  form_open_multipart('frontend/auth_login/teacherpaid',['class'=>'form-horizontal','id'=>'form1',"name" => "form1",'role'=>'form']); ?>
        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-3">
              <input type="text" class="form-control" id="min2" placeholder="Email Id" name="email" value="<?= set_value('email',$email)?>">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-3">
              <input type="password" class="form-control" id="min" placeholder="Password" name="pass" value="<?= set_value('pass',$password)?>">
            ...
            <div class="col-lg-3">
              <input type="password" class="form-control" id="min11" placeholder="Password Confirm" name="cpass" value="<?= set_value('cpass',$password)?>">
...
<?php $user = User::find_by_id($this->session->userdata('user_id'));?>
