...
<script> swal("Good job!", "Payment Successful! Please Check Your Mail", "success");</script>
   <?php  
                              $this->load->helper('cookie');
                               delete_cookie("Total");
                               delete_cookie("Subtotal");
                               delete_cookie("Tax");
                               delete_cookie("PaymentMethod");
                               delete_cookie("PayerStatus");
                               delete_cookie("PayerMail");
                               delete_cookie("CreateTime");
                               delete_cookie("UpdateTime");
                               delete_cookie("State");
                               delete_cookie("cust_id");
                               delete_cookie("payment_id"); 
} ?>
                                ...
                                <div id="mydiv1">
                                  ...
                                  <p><div class="container-fluid">
                                      <div class="row">
                                          ...
                                          <div class="col-md-offset-1 col-md-5"><button class="btn btn-primary btn-sm" style="padding:0px; text-transform: lowercase;   ">Countinue With Payment</button></div>
                                      </div>
                                  </div></p>
                              </div>
                          </div>
 ...
 <h3><?= $this->session->flashdata('succ'); ?></h3>
     ...
     if ($currentGroups==2) {
      ...
      elseif ($currentGroups==3) { ?>
             ...
             <ul class="stars list-group" style="margin-left: 45px;" data-toggle="modal" data-target="#conf1">
...
//     exit;
      ?>     
                                                    ...
                                                    <?php if ($currentGroups==2) { echo " "; } elseif ($currentGroups==3) {echo " "; }elseif ($currentGroups==4) {echo " ";} elseif ($currentGroups==5) 
                                                    {
                                                      ...
                                                      <?php
                                                        if ($currentGroups == 2) {
                                                            ...
                                                            <?php  
                                                                    ...
                                                                    if(in_array($this->uri->segment(3), $cc)) { echo ""; }else{ ?>
                                                      ...
                                                      <li class=" btn btn-primary btn-block"><a href="<?= site_url('calenderview/teachersdetail/'.$user->id); ?>" style="color: white;">Book Now</a></li>

                                                     <?php   }  elseif ($currentGroups == 5) { ?>

                                                            <li class=" btn btn-primary btn-block"><a href="<?= site_url('teachers_book_center/teachersdetail/'.$user->id); ?>" style="color: white;">book teacher</a></li>
                                                      <?php  } ?>
                                       ...
                                       <div class="embed-responsive embed-responsive-16by9">
                                        <?php 
                                                        if($youtube_url)
                                                        {
                                                             ...
                                                             <iframe autoplay="false" class="embed-responsive-item video" src="https://www.youtube.com/embed/<?= stripslashes($vedio); ?>" ></iframe>
                                                                    ...
                                                                    if($vedio != "")
                                                                        { ?>
                                                                          <video width="320" height="240" controls="controls" autoplay="autoplay">
                                                                               <source src="<?= base_url();?>uploads/video/<?= $vedio; ?>" type="video/mp4">
                                                                               <source src="<?= base_url();?>uploads/video/<?= $vedio; ?>" type="video/avi">
                                    ...
                                    <div class="row">
                                      ...
                                      <h3><center>About Me</center></h3>
                                                     ...
                                                     <div id="demo" class="collapse">
                                                      ...
                                                      <a  id="view1" data-toggle="collapse" data-target="#demo"><b>Read More</b></a>
                                                        

                                                      <a  id="view2" data-toggle="collapse" data-target="#demo"><b>Read Less</b></a>
                                  ...
                                  <div class="tab-pane fade" id="profile">
                                   <div class="col-md-10"> <p>
                                      <div class="well">
                                         ...
                                         <div id="detail"> 
                                        <p><div class="col-md-6"><strong>Gender:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></div> <?= $gender ?></p>

                                        <p><div class="col-md-6"><strong>Age:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></div> <?= $age ?></p>

                                        <p><div class="col-md-6"><strong>Country:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></div> <?= $country ?></p>

                                        <p><div class="col-md-6"><strong>City:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong> </div><?= $city ?></p>

                                        <p><div class="col-md-6"><strong>Education:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></div> <?= $education ?></p>

                                        <p><div class="col-md-6"><strong>University:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></div> <?= $university ?></p>
                                        <?php
                                        if($lang1)
                                        {
                                            ?>
                                       ...
                                       <?php }
                                        ...
                                        ?>
                                         ...
                                         <?php if ($currentGroups==2) 
                                            ...
                                            elseif ($currentGroups==4) 
                                                {echo " ";} 
                                            elseif ($currentGroups==5) 
                                                {?>  <p><div class="col-md-6"><strong>Whatsup:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></div> <?= $whatsup ?></p>
                                               <?php } ?>
                                        ...
                                        ?>
                                         ...
                                         <a  id="detail1" data-toggle="collapse" data-target="#demo"><b>Read More</b></a>
                                                        

                                                      <a  id="detail2" data-toggle="collapse" data-target="#demo"><b>Read Less</b></a>
                                   </div>
                  ...
                  ?>
                    ...
                    <?php //  echo "<pre>"; print_r($this->cart->contents());   ?>
                      <?php foreach ($this->cart->contents() as $items): ?>
                        ...
                        <tr>
                          <td>
                            <input type="checkbox" name="del[]" id="del" value="<?php echo $items['rowid']; ?>">
                          </td>
                          <td>
                            <?php echo $j++; ?>
                          </td>
                   ...
                   var ourObj = {};
                    ...
                    data: {"points" : JSON.stringify(ourObj)},
                     success: function(data){ 
                       ...
                       setTimeout(function(){ window.location = "<?php echo base_url('calenderview/save_order'); ?>"; }, 1000);
                       $('#print11').click();
                   ...
                   var ourObj = {};
                    ...
                    data: {"points" : JSON.stringify(ourObj)},
                     success: function(data){ 
                       ...
                       setTimeout(function(){ window.location = "<?php echo base_url('calenderview/save_order1'); ?>"; }, 1000);
                       $('#print11').click();
                                                ...
                                                ,
                                                  ...
                                                  var insti = '<?php $currentGroups==5 ?>';
                                                    if(insti){
                                                        ...
                                                        // $('#paypal-button-container1').click();
                                                    ...
                                                    <div class="col-md-12 table-responsive">
                                                                ...
                                                                <tbody>
                                                                  <tr>
                                                                    ...
                                                                    <td><?= $this->input->cookie('email');?></td>
                                                                    <td><?= $this->input->cookie('PayerMail');?></td>
                                                                    <td>Online class</td>
                                                                    <td><?= $this->input->cookie('saleId');?></td>
                                                                    <td><?= $this->input->cookie('Subtotal');?></td>
                                                                </tr>
