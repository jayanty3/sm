      ...
      <center><a href="javascript:void(0)" class=" btn btn-primary ">Register Individuals</a></center>
          ...
          <br></legend>
                          <div class="col-md-6 col-md-offset-3" ">    
                                <?php echo form_open('register-individuals');  ?>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-12 well ">
                                             ...
                                             <label class="col-md-6" for="fee">
                                             <input type="checkbox" name="levels[]"  value="Intermediate" <?php echo set_checkbox('levels[]', 'Intermediate'); ?> data-validation="checkbox_group" data-validation-qty="min1" >
                                             &nbsp;&nbsp;&nbsp;Intermediate
                                             </label>
                                             <label class="col-md-6" for="fee">
